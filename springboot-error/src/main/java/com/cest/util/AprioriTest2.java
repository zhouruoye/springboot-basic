 ...
 * @create 2020-11-06 15:08
 * @comment
 */

public class AprioriTest2 {
    // 支持度阈值
    private final static int SUPPORT = 1;
    // 置信度阈值
    ...
    private static void importData(ArrayList<String> dataList){

        File file = new File("/Users/chenghuan/publish/java/idea/think-wf-stactivity/web/src/test/java/com/tennetcn/test/data/ast_cgy_ecd_clm.dat");
...
//        importData(dataList);
        ...
        AprioriTest2 apriori2 = new AprioriTest2();
